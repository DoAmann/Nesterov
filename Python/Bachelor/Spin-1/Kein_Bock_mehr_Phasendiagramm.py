...
def groundstate(q , delta, params):
    ...
    return Psi2_0, Psi2_neg, Psi2_pos, F_perp, F_z, q, c1
...
delta = np.linspace(-10e-2, 10e-2, 20)
q = np.linspace(-80, 80, 20)
...
np.savez("daten.npz", array1 = result, array2 = q_unitless, array3 = c1_unitless)